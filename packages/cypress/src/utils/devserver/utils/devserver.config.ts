...
import { DevServeExecutorOptions, DevServerOptions } from './types';

export function getDevServerConfig(
  workspaceRoot: string,
  projectRoot: string,
  sourceRoot: string,
  buildOptions: DevServerOptions,
  serveOptions: DevServeExecutorOptions
...
function getDevServerPartial(
  root: string,
  options: DevServeExecutorOptions,
  buildOptions: DevServerOptions
...
function getSslConfig(root: string, options: DevServeExecutorOptions) {
  return {
...
function getProxyConfig(root: string, options: DevServeExecutorOptions) {
